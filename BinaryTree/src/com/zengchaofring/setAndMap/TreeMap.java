...
public class TreeMap<K, V> implements Map<K, V> {
     ...
     * @Date 15:46 2020/9/24
     * @Param [node]
     * @Return com.zengchaofring.setAndMap.TreeMap.Node<K,V>
     **/
     ...
     * @Param [node]
     * @Return com.zengchaofring.trees.BinarySearchTree.Node<K, V>
     **/
    protected Node<K, V> successor(Node<K, V> node) {
        if (node == null) return null;

        Node<K, V> c = node.right;
        if (c != null) {
            while (c.left != null) {
                c = c.left;
            }
     ...
     * @Param [node, color]
     * @Return com.zengchaofring.trees.Node<K, V>
     **/
    private Node<K, V> colored(Node<K, V> node, boolean color) {
    ...
    /*
     * @Author carl
     * @Description 映射特有的类节点
     * @Date 15:47 2020/9/24
     * @Param [key, value, parent]
     * @Return com.zengchaofring.setAndMap.TreeMap.Node<K,V>
     **/
